...
Si le contexte retombe à **65 536 tokens** au lieu des fenêtres réelles :
...
Fenêtres de contexte à exposer à Codex :

| Modèle | Provider | `context_window` recommandé |
| --- | --- | ---: |
| DeepSeek V4 Flash / Pro | DeepSeek direct | 1 048 576 |
| DeepSeek V4 Pro | NVIDIA NIM | 1 048 576 |
| GLM-5.1 | NVIDIA NIM / Z.AI | 200 000 |
| Qwen3-Coder-Next | Hugging Face | 262 144 |
| MiniMax M3 `minimax-m3:cloud` | Ollama Cloud | jusqu'à 1 048 576, minimum garanti 512 000 côté modèle |
